...
//                    g.setColor(c);
//                } else if (current.grid[i][j] <= maxTemp*20/1000) {
//                    c = new Color(255,110,80);
//                    g.setColor(c);
//                } else if (current.grid[i][j] <= maxTemp) {
//                    c = new Color(255,80,40);
//                    g.setColor(c);
//                } else if (current.grid[i][j] > maxTemp*100) {
//                    c = new Color(210,0, 255);
//                    g.setColor(c);
//                } else if (current.grid[i][j] > maxTemp*10) {
//                    c = new Color(255, 53, 225);
//                    g.setColor(c);
//                } else if (current.grid[i][j] > maxTemp) {
//                    c = new Color(255, 118, 228);
//                    g.setColor(c);
//                }
//                g.fillRect(pixSize*i, pixSize*j, pixSize, pixSize);
