...
public class GUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(java.awt.Toolkit.getDefaultToolkit().getScreenSize().width*55/100,java.awt.Toolkit.getDefaultToolkit().getScreenSize().height));
        jPanel1.setPreferredSize(new java.awt.Dimension(java.awt.Toolkit.getDefaultToolkit().getScreenSize().width,java.awt.Toolkit.getDefaultToolkit().getScreenSize().height*7/8));
        ...
        layout.setVerticalGroup(
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                .addComponent(jPanel1, javax.swing.GroupLayout.PREFERRED_SIZE, java.awt.Toolkit.getDefaultToolkit().getScreenSize().height*6/8, javax.swing.GroupLayout.PREFERRED_SIZE)
